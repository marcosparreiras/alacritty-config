...
```sh
# ~/.p10k.zsh
# Generated by Powerlevel10k configuration wizard on 2024-11-10 at 22:28 -03.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                   # \n
    # kubecontext               # context/namespace kubectl
  )
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=46
